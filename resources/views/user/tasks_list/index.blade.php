    ...
    <ul class="list-group">
        @foreach ($tasks as $task)
            <li class="list-group-item">
                <div class="d-flex justify-content-around alert {{ $task->state->type === 'completado' ?  'alert-success' : 'alert-warning' }} ">
                    ...
                    <span>
                        ...
                        <form action="{{ route('task.update_state', ['id' => $task->id]) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PUT')
                            @if ($task->state->type === 'completado')
                                <button class="btn btn-danger" onclick="return confirm('¿Estás seguro de que quieres devolver el estado de la tarea?')">
                                    <i class="fas fa-minus"></i>
                                </button>
                            @else
                                <button class="btn btn-success" onclick="return confirm('¿Estás seguro de que quieres aprobar esta tarea?')">
